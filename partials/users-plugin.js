var usersList = {
  ...
  _activate: function (e) {
    ...
    minAjax({
      url:"/abe/plugin/abe-users/activate",
      type:"POST",
      data: {
        id: id
      },
  ...
  _deactivate: function (e) {
    ...
    var id = target.getAttribute('data-user-id')
    minAjax({
      url:"/abe/plugin/abe-users/deactivate",
      type:"POST",
      data: {
        id: id
      },
  ...
  _update: function (e) {
    ...
    minAjax({
      url:"/abe/plugin/abe-users/update",
      type:"POST",
      data: data,
      success: function(data) {
  ...
  _remove: function (e) {
    ...
    var id = target.getAttribute('data-user-id')
    minAjax({
      url:"/abe/plugin/abe-users/remove",
      type:"POST",
      data: {
        id: id
      },
